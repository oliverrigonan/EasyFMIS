...
{
    public class DgvSalesInvoiceItemEntitySalesOrderitemEntity
    {
        public Int32 ColumnTrnSalesOrderItemListId { get; set; }
        public Int32 ColumnTrnSalesOrderItemListSOId { get; set; }
        public String ColumnTrnSalesOrderItemListBarCode { get; set; }
        ...
        public String ColumnSalesOrderItemListPick { get; set; }
    }
}
