...
namespace easyfmis.Forms.Software.TrnSalesOrder
{
    public partial class TrnSalesOrderDetailSalesOrderItemDetailPriceForm : Form
    {
        ...
        public static List<Entities.DgvTrnSalesOrderItemSearchItemDetailPrice> itemPriceListData = new List<Entities.DgvTrnSalesOrderItemSearchItemDetailPrice>();
        public PagedList<Entities.DgvTrnSalesOrderItemSearchItemDetailPrice> itemPriceListPageList = new PagedList<Entities.DgvTrnSalesOrderItemSearchItemDetailPrice>(itemPriceListData, pageNumber, pageSize);
        ...
        {
            List<Entities.DgvTrnSalesOrderItemSearchItemDetailPrice> getItemPriceListData = await GetItemPriceListDataTask();
            if (getItemPriceListData.Any())
            {
                itemPriceListData = getItemPriceListData;
                itemPriceListPageList = new PagedList<Entities.DgvTrnSalesOrderItemSearchItemDetailPrice>(itemPriceListData, pageNumber, pageSize);
            ...
            else
            {
                ...
                itemPriceListData = new List<Entities.DgvTrnSalesOrderItemSearchItemDetailPrice>();
                itemPriceListDataSource.Clear();
                textBoxItemPriceListPageNumber.Text = "1 / 1";
            }
        }

        public Task<List<Entities.DgvTrnSalesOrderItemSearchItemDetailPrice>> GetItemPriceListDataTask()
        {
            ...
            if (listItemPrice.Any())
            {
                var itemPrices = from d in listItemPrice
                                 select new Entities.DgvTrnSalesOrderItemSearchItemDetailPrice
                                 {
            ...
            {
                return Task.FromResult(new List<Entities.DgvTrnSalesOrderItemSearchItemDetailPrice>());
            }
        }
        ...
        {
            itemPriceListPageList = new PagedList<Entities.DgvTrnSalesOrderItemSearchItemDetailPrice>(itemPriceListData, 1, pageSize);
            itemPriceListDataSource.DataSource = itemPriceListPageList;
        ...
        {
            itemPriceListPageList = new PagedList<Entities.DgvTrnSalesOrderItemSearchItemDetailPrice>(itemPriceListData, itemPriceListPageList.PageCount, pageSize);
            itemPriceListDataSource.DataSource = itemPriceListPageList;
