        ...
        private void GeneratePDFSalesInvoiceDRDetail()
        {
            try
            {
                ...
                if (salesInvoice.Any())
                {
                    ...
                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase(address, fontNew10)) { Border = 0, PaddingTop = 3f, PaddingLeft = 5f, PaddingRight = 5f });
                    ...
                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase(salesPerson, fontNew07)) { Border = 0, PaddingTop = 6f, PaddingLeft = 5f, PaddingRight = 5f, HorizontalAlignment = 2 });
                    ...
                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase("Remarks: ", fontNew10Bold)) { Border = 0, PaddingTop = 3f, PaddingLeft = 5f, PaddingRight = 5f, HorizontalAlignment = 2 });
                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase(salesRemarks, fontNew10)) { Border = 0, PaddingTop = 3f, PaddingLeft = 5f, PaddingRight = 5f, HorizontalAlignment = 2 });
                    ...
                    if (salesInvoiceItems.Any())
                    {
                        ...
                        //tableSalesInvoiceItems.AddCell(new PdfPCell(new Phrase("Particulars", fontNew10Bold)) { HorizontalAlignment = 1, PaddingTop = 3f, PaddingBottom = 7f });
                        ...
                        foreach (var salesInvoiceItem in salesInvoiceItems)
                        {
                            ...
                            tableSalesInvoiceItems.AddCell(new PdfPCell(new Phrase(salesInvoiceItem.Quantity.ToString("#,##0.00"), fontNew08)) { Border = 0, HorizontalAlignment = 2, PaddingTop = 3f, PaddingBottom = paddingBottom, PaddingLeft = 5f, PaddingRight = 5f });
                            tableSalesInvoiceItems.AddCell(new PdfPCell(new Phrase(salesInvoiceItem.MstUnit.Unit, fontNew08)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 3f, PaddingBottom = paddingBottom, PaddingLeft = 5f, PaddingRight = 5f });
                            tableSalesInvoiceItems.AddCell(new PdfPCell(new Phrase(salesInvoiceItem.MstArticle.ArticleBarCode, fontNew08)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 3f, PaddingBottom = paddingBottom, PaddingLeft = 5f, PaddingRight = 5f });
                            tableSalesInvoiceItems.AddCell(new PdfPCell(new Phrase(salesInvoiceItem.MstArticle.Article, fontNew08)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 3f, PaddingBottom = paddingBottom, PaddingLeft = 5f, PaddingRight = 5f });
                            //tableSalesInvoiceItems.AddCell(new PdfPCell(new Phrase(particulars, fontNew10)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 3f, PaddingBottom = paddingBottom, PaddingLeft = 5f, PaddingRight = 5f });
                            tableSalesInvoiceItems.AddCell(new PdfPCell(new Phrase(salesInvoiceItem.NetPrice.ToString("#,##0.00"), fontNew08)) { Border = 0, HorizontalAlignment = 2, PaddingTop = 3f, PaddingBottom = paddingBottom, PaddingLeft = 5f, PaddingRight = 5f });
                            tableSalesInvoiceItems.AddCell(new PdfPCell(new Phrase(salesInvoiceItem.Amount.ToString("#,##0.00"), fontNew08)) { Border = 0, HorizontalAlignment = 2, PaddingTop = 3f, PaddingBottom = paddingBottom, PaddingLeft = 5f, PaddingRight = 5f });
                        ...
                        tableSalesInvoiceItems.AddCell(new PdfPCell(new Phrase("Total", fontNew10Bold)) { Colspan = 5, HorizontalAlignment = 2, PaddingTop = 3f, PaddingBottom = 7f, PaddingLeft = 5f, PaddingRight = 5f });
                        tableSalesInvoiceItems.AddCell(new PdfPCell(new Phrase(totalAmount.ToString("#,##0.00"), fontNew10Bold)) { Colspan = 1, HorizontalAlignment = 2, PaddingTop = 3f, PaddingBottom = 7f, PaddingLeft = 5f, PaddingRight = 5f });
        ...
        private void GeneratePDFSalesInvoice()
        {
            try
            {
                ...
                if (salesInvoice.Any())
                {
                    ...
                    tableHeader.AddCell(new PdfPCell(new Phrase("", fontNew13)) { Border = 0, HorizontalAlignment = Element.ALIGN_RIGHT });
                    tableHeader.AddCell(new PdfPCell(new Phrase("", fontNew13)) { Border = 0, HorizontalAlignment = Element.ALIGN_RIGHT });
                    //tableHeader.AddCell(new PdfPCell(new Phrase(salesNo, font13)) { Border = 0, PaddingTop = 7f, HorizontalAlignment = Element.ALIGN_RIGHT, FixedHeight = 28f });
                    ...
                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase(soldTo, fontNew08)) { Colspan = 3, Border = 0, PaddingLeft = 3f, PaddingRight = 5f, FixedHeight = 12f });
                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase(" ", fontNew08)) { PaddingLeft = 3f, Border = 0, PaddingRight = 5f, FixedHeight = 12f });
                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase(salesDate, fontNew08)) { PaddingLeft = 3f, Border = 0, PaddingRight = 5f, HorizontalAlignment = 0, FixedHeight = 12f });


                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase(" ", fontNew08)) { Border = 0, PaddingLeft = 3f, PaddingRight = 5f, FixedHeight = 12f });
                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase(TIN, fontNew08)) { Border = 0, PaddingLeft = 3f, PaddingRight = 5f, FixedHeight = 12f });
                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase(" ", fontNew08)) { Border = 0, PaddingLeft = 3f, PaddingRight = 5f, FixedHeight = 12f });
                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase(" ", fontNew08)) { Border = 0, PaddingLeft = 3f, PaddingRight = 5f, FixedHeight = 12f });
                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase(" ", fontNew08)) { Border = 0, PaddingLeft = 3f, PaddingRight = 5f, FixedHeight = 12f });
                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase(" ", fontNew08)) { Border = 0, PaddingLeft = 3f, PaddingRight = 5f, FixedHeight = 12f });
                    ...
                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase(address, fontNew08)) { Colspan = 3, Border = 0, PaddingLeft = 3f, PaddingRight = 5f, FixedHeight = 25f });
                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase(" ", fontNew08)) { PaddingLeft = 3f, Border = 0, PaddingRight = 5f, FixedHeight = 12f });
                    //tableSalesInvoice.AddCell(new PdfPCell(new Phrase(currentSIPrefix + "-" + salesInvoice.FirstOrDefault().MstBranch.BranchCode + "-" + salesNo, fontNew08)) { Border = 0, PaddingLeft = 3f, PaddingRight = 5f, HorizontalAlignment = 0, FixedHeight = 12f });
                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase(manualSINumber, fontNew08)) { Border = 0, PaddingLeft = 3f, PaddingRight = 5f, HorizontalAlignment = 0, FixedHeight = 12f });
                    ...
                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase("", fontNew08)) { Border = 0, PaddingLeft = 3f, PaddingRight = 5f, FixedHeight = 12f });
                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase(" ", fontNew08)) { Border = 0, PaddingLeft = 3f, PaddingRight = 5f, FixedHeight = 12f });
                    tableSalesInvoice.AddCell(new PdfPCell(new Phrase(term, fontNew08)) { Border = 0, PaddingLeft = 3f, PaddingRight = 5f, FixedHeight = 12f });
                    ...
                    if (salesInvoiceItems.Any())
                    {
                        if (count < 19)
                        {
                            foreach (var salesInvoiceItem in salesInvoiceItems)
                            {
                                ...
                                tableSalesInvoiceItems.AddCell(new PdfPCell(new Phrase(salesInvoiceItem.Quantity.ToString("#,##0.00"), fontNew08)) { Border = 0, HorizontalAlignment = 2, PaddingBottom = paddingBottom, PaddingLeft = 3f, PaddingRight = 5f });
                                tableSalesInvoiceItems.AddCell(new PdfPCell(new Phrase(salesInvoiceItem.MstUnit.Unit, fontNew08)) { Border = 0, HorizontalAlignment = 0, PaddingBottom = paddingBottom, PaddingLeft = 3f, PaddingRight = 5f });
                                tableSalesInvoiceItems.AddCell(new PdfPCell(new Phrase(salesInvoiceItem.MstArticle.Article, fontNew08)) { Border = 0, HorizontalAlignment = 0, PaddingBottom = paddingBottom, PaddingLeft = 3f, PaddingRight = 5f });
                                tableSalesInvoiceItems.AddCell(new PdfPCell(new Phrase(salesInvoiceItem.NetPrice.ToString("#,##0.00"), fontNew08)) { Border = 0, HorizontalAlignment = 2, PaddingBottom = paddingBottom, PaddingLeft = 3f, PaddingRight = 5f });
                                tableSalesInvoiceItems.AddCell(new PdfPCell(new Phrase(salesInvoiceItem.Amount.ToString("#,##0.00"), fontNew08)) { Border = 0, HorizontalAlignment = 2, PaddingBottom = paddingBottom, PaddingLeft = 3f, PaddingRight = 5f });
                        ...
                        //tableSalesInvoiceItems.AddCell(new PdfPCell(new Phrase("Total", fontNew10Bold)) { Colspan = 6, HorizontalAlignment = 2, PaddingTop = 3f, PaddingBottom = 7f, PaddingLeft = 5f, PaddingRight = 5f });
                        //tableSalesInvoiceItems.AddCell(new PdfPCell(new Phrase(totalAmount.ToString("#,##0.00"), fontNew10Bold)) { HorizontalAlignment = 2, PaddingTop = 3f, PaddingBottom = 7f, PaddingLeft = 5f, PaddingRight = 5f });
                        ...
                        tableSalesInvoiceComputation.AddCell(new PdfPCell(new Phrase(salesRemarks, fontNew08)) { Border = 0, Colspan = 3, PaddingLeft = 3f, PaddingRight = 5f, FixedHeight = 12f, HorizontalAlignment = 2 });
                        ...
                        tableSalesInvoiceComputation.AddCell(new PdfPCell(new Phrase(zeroRatedSales.ToString("#,##0.00"), fontNew08)) { Border = 0, PaddingLeft = 3f, PaddingRight = 5f, FixedHeight = 24f, HorizontalAlignment = 2, PaddingTop = 8f, });
                        ...
                        tableSalesInvoiceComputation.AddCell(new PdfPCell(new Phrase(_12PercentVat.ToString("#,##0.00"), fontNew08)) { Border = 0, PaddingLeft = 3f, PaddingRight = 5f, FixedHeight = 12f, HorizontalAlignment = 2 });

                        tableSalesInvoiceComputation.AddCell(new PdfPCell(new Phrase(" ", fontNew08)) { Border = 0, Colspan = 4, PaddingLeft = 3f, PaddingRight = 5f, FixedHeight = 12f });
                        tableSalesInvoiceComputation.AddCell(new PdfPCell(new Phrase(totalAmount.ToString("#,##0.00"), fontNew08)) { Border = 0, PaddingLeft = 3f, PaddingRight = 5f, FixedHeight = 12f, HorizontalAlignment = 2 });
                        ...
                        tableSalesInvoiceItemsContainer.AddCell(new PdfPCell(new Phrase(" ", fontNew08)) { Border = 0, Colspan = 5, FixedHeight = 94f });
