...
namespace easyfmis.Forms.Software.TrnStockIn
{
    public partial class TrnStockInDetailSearchItemForm : Form
    {
        ...
        public Task<List<Entities.DgvSearchItemEntity>> GetSearchItemDataTask()
        {
            ...
            List<Entities.MstArticleEntity> listSearchItem = trnStockInItemController.ListItem(filter);
        ...
        private void dataGridViewSearchItem_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridViewSearchItem.CurrentCell.ColumnIndex == dataGridViewSearchItem.Columns["ColumnSearchItemButtonPick"].Index)
            {
                ...
                TrnStockInDetailStockInItemDetailForm trnStockInDetailStockInItemDetailForm = new TrnStockInDetailStockInItemDetailForm(trnStockInDetailForm, trnStockInItemEntity);
